    ...
    <main>
        ...
        <section class="border-bottom pb-5 pt-5 text-center">
            <div class="container pb-5 pt-5">
                ...
                <h3 class="float-start" style="padding-left: 9px;">Edit Centers</h3>
                ...
                <div class="container " style="margin-left: 20px;">
                    <form method="get" action="">
                        ...
                        <button class="btn btn-light float-none rounded-pill" type="submit" name="action" value="searchupdateCenter" style="margin-right: 950px"><img src="https://cdn-icons-png.flaticon.com/512/622/622669.png" width="20px"></button>
                    </form>
